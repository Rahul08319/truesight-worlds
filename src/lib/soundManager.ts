...
class SoundManager {
  ...
  chatMessage() {
    this.playTone(880, 0.05, 'sine', 0.03);
    setTimeout(() => this.playTone(1100, 0.06, 'sine', 0.025), 50);
  }

  chatEmoji() {
    this.playTone(1200, 0.04, 'triangle', 0.035);
    setTimeout(() => this.playTone(1500, 0.05, 'triangle', 0.03), 40);
    setTimeout(() => this.playTone(1800, 0.04, 'triangle', 0.025), 80);
  }
}
